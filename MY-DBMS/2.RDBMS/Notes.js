...
There are mainly 6 types of Keys :-
        ...
        Foreign Key - 
            ...
            * Ex - Consider two tables, Students and Enrollments.
            Students Table
                StudentID	Name	Age
                1	        John	20
                2	        Alice	22
            ...
            Enrollments Table
                ...
                103	            3	        History
                104	            1	        Science
            * Foreign Key - StudentID in the Enrollments table refers to StudentID in the Students table.
        Candidate Key - 
            ...
            * Ex - In the Students table.
            StudentID	Name	Age
            1	        John	20
            2	        Alice	22
            3	        Bob	    21
            Candidate Keys - StudentID, (Name, Age)
        Alternate Key - 
            * An alternate key is any candidate key which is not chosen as the primary key.
            * Ex - In the Students table, if StudentID is the primary key.
            StudentID	Name	Age
            1	        John	20
            2	        Alice	22
            3	        Bob	    21
            * Alternate Key - (Name, Age)
        Super Key - 
            * A super key is a set of one or more columns (attributes) that can uniquely identify a row in a table. 
            ...
            * Ex - In the Students table.
            ...
            2	        Alice	22
            3	        Bob	    21
            * Super Keys - StudentID, (StudentID, Name), (StudentID, Age), (StudentID, Name, Age)
        Secondary Key - 
            * A secondary key is an attribute or a combination of attributes that are not the primary key but are used for data retrieval purposes.
            * Ex - In the Students table.
            StudentID	Name	Age
            1	        John	20
            2	        Alice	22
            3	        Bob	    21
            * Secondary Key - Name (if we frequently query based on Name)
        Composite Key - 
            * A composite key is a primary key that consists of two or more attributes that together uniquely identify a record.
            * Ex - Consider a CourseEnrollments table.
            CourseID	StudentID	EnrollmentDate
            1001	    1	        2023-01-15
            1002	    2	        2023-01-16
            1003	    3	        2023-01-17
            1001	    2	        2023-01-18
...
Answer :
SQL privileges define the level of access that users or roles hae to perform certain operations on database objects.
