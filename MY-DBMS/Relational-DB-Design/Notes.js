...
Answer :
Insertion Anomaly - Inability to add data to the database due to missing attributes.
Update Anomaly - Inconsistency that arises when data is updated in one place but not in another.
...
Rules :-   
    * Be in 2NF.
    * Every non-key attribute of the relation is non-transitively dependent on each candidate key of the relation.
Purpose :- 
    * Eliminate transitive dependencies.
Steps :- 
    * Ensuring that no non-key attribute depends on another non-key attribute.
